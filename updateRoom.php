...
<!-- inline scripts related to this page -->
								...
								function check_all(){
									...
									if(rooms[i].id !=""){
									document.getElementById(rooms[i].id).disabled=false;
									}}}
									else{
									for (i = 1; i < rooms.length; i++) {
									rooms[i].checked=false;	
									if(rooms[i].id !=""){
									document.getElementById(rooms[i].id).disabled=true;
									}}}
									
								}
								function updatePricevalue(value,checkbox){
								...
								$(document).ready(function(){
										...
										xmlhttp.open("GET", "table_update.php", true);
										xmlhttp.send();  
								...
								$(document.body).on('click', '.table_price' ,function(){
									oldVal = $(this).val();
									});
								$(document.body).on('blur', '.table_price' ,function(){
									var newVal = $(this).val();
									if(newVal != oldVal){
