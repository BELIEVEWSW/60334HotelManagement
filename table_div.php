...
echo 'Room Number </th>  <th class="center"> Room Type</th><th class="center"> Price </th><th class="center">Pet Available</th><th class="center">Smoke Available</th><th class="center">Delete   <input type="checkbox" name="all" value="all" onclick="check_all()"></th></tr></thead> <tbody>';
for ($j = 0 ; $j < $rows ; ++$j)
  { echo '<tr>';
    $result->data_seek($j);
	...
	echo '<td class="center"><input type="checkbox" name="rooms[]" class="table_check" value="'.$row['room_number'].'"> </td>';
    echo '</tr>';
  }
